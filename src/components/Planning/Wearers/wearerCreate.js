...
export default class provinceCreate extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/wearer', newWearer)
        ...
        return (
            <div style={{marginTop: 20}}>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Create Pemakai Kontrasepsi" className="btn btn-primary" />
                    </div>
                </form>
            </div>
        )
